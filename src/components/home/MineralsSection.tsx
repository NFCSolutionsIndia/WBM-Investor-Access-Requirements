...
const allMinerals = [
  ...
  { symbol: "Nd", num: 60, name: "Neodymium", row: 9, col: 6, wbm: true, color: "#839470", desc: "Super-magnets for EV motors and wind turbines.", from: "Rare Earth Elements", offtake: "Tesla, Vestas, GE" },
  ...
  { symbol: "Dy", num: 66, name: "Dysprosium", row: 9, col: 12, wbm: true, color: "#839470", desc: "Enhances heat resistance in high-performance magnets.", from: "Rare Earth Elements", offtake: "Defence, Aerospace" },
