...
`;e.s(["default",0,function({focal:e=[.5,.5],rotation:i=[1,0],starSpeed:o=.5,density:n=1,hueShift:h=140,disableAnimation:v=!1,speed:m=1,mouseInteraction:p=!0,glowIntensity:x=.3,saturation:g=0,mouseRepulsion:y=!0,repulsionStrength:b=2,twinkleIntensity:w=.3,rotationSpeed:k=.1,autoCenterRepulsion:j=0,transparent:R=!0,...M}){let S=(0,c.useRef)(null),A=(0,c.useRef)({x:.5,y:.5}),N=(0,c.useRef)({x:.5,y:.5}),C=(0,c.useRef)(0),T=(0,c.useRef)(0);return(0,c.useEffect)(()=>{let t,c;if(!S.current)return;let M=S.current,L=new a.Renderer({alpha:R,premultipliedAlpha:!1}),z=L.gl;function F(){L.setSize(+M.offsetWidth,+M.offsetHeight),t&&(t.uniforms.uResolution.value=new l(z.canvas.width,z.canvas.height,z.canvas.width/z.canvas.height))}R?(z.enable(z.BLEND),z.blendFunc(z.SRC_ALPHA,z.ONE_MINUS_SRC_ALPHA),z.clearColor(0,0,0,0)):z.clearColor(0,0,0,1),window.addEventListener("resize",F,!1),F();let U=new u.Triangle(z);t=new r.Program(z,{vertex:d,fragment:f,uniforms:{uTime:{value:0},uResolution:{value:new l(z.canvas.width,z.canvas.height,z.canvas.width/z.canvas.height)},uFocal:{value:new Float32Array(e)},uRotation:{value:new Float32Array(i)},uStarSpeed:{value:o},uDensity:{value:n},uHueShift:{value:h},uSpeed:{value:m},uMouse:{value:new Float32Array([N.current.x,N.current.y])},uGlowIntensity:{value:x},uSaturation:{value:g},uMouseRepulsion:{value:y},uTwinkleIntensity:{value:w},uRotationSpeed:{value:k},uRepulsionStrength:{value:b},uMouseActiveFactor:{value:0},uAutoCenterRepulsion:{value:j},uTransparent:{value:R}}});let O=new s.Mesh(z,{geometry:U,program:t});function E(e){let t=M.getBoundingClientRect();A.current={x:(e.clientX-t.left)/t.width,y:1-(e.clientY-t.top)/t.height},C.current=1}function P(){C.current=0}return c=requestAnimationFrame(function e(a){c=requestAnimationFrame(e),v||(t.uniforms.uTime.value=.001*a,t.uniforms.uStarSpeed.value=.001*a*o/10),N.current.x+=(A.current.x-N.current.x)*.05,N.current.y+=(A.current.y-N.current.y)*.05,T.current+=(C.current-T.current)*.05,t.uniforms.uMouse.value[0]=N.current.x,t.uniforms.uMouse.value[1]=N.current.y,t.uniforms.uMouseActiveFactor.value=T.current,L.render({scene:O})}),M.appendChild(z.canvas),p&&(M.addEventListener("mousemove",E),M.addEventListener("mouseleave",P)),()=>{cancelAnimationFrame(c),window.removeEventListener("resize",F),p&&(M.removeEventListener("mousemove",E),M.removeEventListener("mouseleave",P)),M.contains(z.canvas)&&M.removeChild(z.canvas),z.getExtension("WEBGL_lose_context")?.loseContext()}},[e,i,o,n,h,v,m,p,x,g,y,w,k,b,j,R]),(0,t.jsx)("div",{ref:S,style:{width:"100%",height:"100%",position:"relative"},...M})}],82759)},61911,e=>{"use strict";let t=(0,e.i(75254).default)("users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744",key:"16gr8j"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}]]);e.s(["Users",0,t],61911)},23609,e=>{"use strict";let t=(0,e.i(75254).default)("landmark",[["path",{d:"M10 18v-7",key:"wt116b"}],["path",{d:"M11.12 2.198a2 2 0 0 1 1.76.006l7.866 3.847c.476.233.31.949-.22.949H3.474c-.53 0-.695-.716-.22-.949z",key:"1m329m"}],["path",{d:"M14 18v-7",key:"vav6t3"}],["path",{d:"M18 18v-7",key:"aexdmj"}],["path",{d:"M3 22h18",key:"8prr45"}],["path",{d:"M6 18v-7",key:"1ivflk"}]]);e.s(["Landmark",0,t],23609)},51859,e=>{"use strict";var t=e.i(43476),a=e.i(46932),r=e.i(61911),s=e.i(25652),i=e.i(66992),o=e.i(15788),n=e.i(23609),l=e.i(32095),u=e.i(72520),c=e.i(82759),d=e.i(59544),f=e.i(57688),h=e.i(94883);e.s(["default",0,()=>{let e=[{title:"Investor",desc:"Four offerings, five revenue streams, ten-year horizon. Semiconductor-grade unit economics for the critical-minerals decade.",bullets:["4×5 revenue model","11 minerals extracted","US patent approved"],icon:(0,t.jsx)(s.TrendingUp,{size:24}),href:"/for-you/investor",cta:"View Thesis",img:"/WBM/media/FinancialServices.jpg"},{title:"Customer / OEM",desc:"Battery-grade lithium, cobalt, nickel, plus precious metals and rare earths — published SLAs, traceable to source.",bullets:["OEM-grade purity","Published SLAs","Battery passport ready"],icon:(0,t.jsx)(i.Cpu,{size:24}),href:"/for-you/customer",cta:"Browse Minerals",img:"/WBM/media/ElectricVehicles.jpg"},{title:"Supplier",desc:"Bring us your batteries, magnets, PCBs, and e-waste. Get paid for what others landfill — with full chain-of-custody.",bullets:["Tipping fees","4 feedstock streams","Documented intake"],icon:(0,t.jsx)(o.Truck,{size:24}),href:"/for-you/supplier",cta:"Start a supply contract",img:"/WBM/media/E-waste_processing.jpg"},{title:"AI Data-Centre Tenant",desc:"Lease compute capacity inside our integrated plants. Power, cooling, and material recovery — all under one roof.",bullets:["Co-located GPU racks","On-site recovery loop","15-year leases"],icon:(0,t.jsx)(r.Users,{size:24}),href:"/for-you/tenant",cta:"Tour the floor",img:"/WBM/media/DataCentersAI.jpg"},{title:"Government",desc:"Critical-mineral sovereignty without Beijing exposure. Domestic recovery, IRA-aligned credits, local job creation.",bullets:["IRA-qualified outputs","Local job creation","Zero Asia exposure"],icon:(0,t.jsx)(n.Landmark,{size:24}),href:"/for-you/government",cta:"See policy fit",img:"/WBM/media/AerospaceDefense.jpg"},{title:"Academia",desc:"Joint research on hydrometallurgy, REE separation, and circular-economy modeling. Plant access for select labs.",bullets:["Joint publications","Plant data access","PhD pipeline"],icon:(0,t.jsx)(l.GraduationCap,{size:24}),href:"/for-you/academia",cta:"Explore partnerships",img:"/WBM/media/SustainablebyDesign.jpg"}];return(0,t.jsxs)("div",{className:"min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] transition-colors duration-500 overflow-x-hidden",children:[(0,t.jsxs)("section",{className:"relative min-h-[70vh] flex items-center overflow-hidden bg-black pt-32 pb-24 transition-colors duration-500",children:[(0,t.jsx)("div",{className:"absolute inset-0 z-0",children:(0,t.jsx)(c.default,{})}),(0,t.jsx)("div",{className:"absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-black z-[1]"}),(0,t.jsx)("div",{className:"max-w-7xl mx-auto px-6 sm:px-8 relative z-10 text-center",children:(0,t.jsxs)(a.motion.div,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.8},className:"max-w-4xl mx-auto",children:[(0,t.jsxs)("div",{className:"inline-flex items-center gap-2 bg-white/5 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 text-[var(--c-lime)] mb-8",children:[(0,t.jsx)("div",{className:"w-2 h-2 bg-[var(--c-lime)] rounded-full animate-pulse"}),(0,t.jsx)("span",{className:"text-[10px] md:text-xs font-bold uppercase tracking-[0.2em]",children:"Our Ecosystem"})]}),(0,t.jsxs)("h1",{className:"text-4xl md:text-[64px] font-black text-white leading-[0.9] tracking-tighter mb-8 uppercase text-glow",children:["For You. ",(0,t.jsx)("br",{})," ",(0,t.jsx)("span",{className:"text-[var(--c-lime)]",children:"Six Journeys."})]}),(0,t.jsx)("p",{className:"text-xl md:text-2xl text-gray-400 font-medium leading-relaxed max-w-2xl mx-auto mb-10",children:"Whether you fund critical-mineral theses, source lithium, supply feedstock, or lease compute — there's a path built for you."})]})})]}),(0,t.jsx)("section",{className:"py-10 bg-[var(--c-bg)]",children:(0,t.jsx)("div",{className:"max-w-7xl mx-auto px-6",children:(0,t.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",children:e.map((e,r)=>(0,t.jsx)(a.motion.div,{initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{delay:.1*r},children:(0,t.jsxs)(h.default,{className:"relative h-[600px] rounded-[10px] overflow-hidden cursor-pointer group",glowColor:"rgba(131, 148, 112, 0.15)",children:[(0,t.jsx)(f.default,{src:e.img,alt:e.title,fill:!0,className:"object-cover transition-transform duration-1000 group-hover:scale-110 opacity-100"}),(0,t.jsx)("div",{className:"absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent"}),(0,t.jsxs)("div",{className:"absolute inset-0 p-8 flex flex-col justify-end transition-transform duration-500 group-hover:translate-y-[-10px]",children:[(0,t.jsx)("div",{className:"w-12 h-12 rounded-full bg-[var(--c-lime)]/20 backdrop-blur-md flex items-center justify-center text-[var(--c-lime)] mb-6 group-hover:bg-[var(--c-lime)] group-hover:text-black transition-colors",children:e.icon}),(0,t.jsx)("h3",{className:"text-[32px] font-black text-white tracking-tighter leading-tight mb-4 uppercase break-words",children:e.title}),(0,t.jsx)("p",{className:"text-sm text-white/60 mb-8 font-medium leading-relaxed",children:e.desc}),(0,t.jsx)("ul",{className:"space-y-3 mb-10 hidden group-hover:block transition-all duration-500",children:e.bullets.map((e,a)=>(0,t.jsxs)("li",{className:"flex items-center gap-3 text-[10px] font-bold text-white uppercase tracking-wide",children:[(0,t.jsx)("div",{className:"w-1 h-1 rounded-full bg-[var(--c-lime)]"}),e]},a))}),(0,t.jsx)(d.default,{href:e.href,className:"w-full bg-[var(--c-highlight)] text-black hover:brightness-110 border-none",children:(0,t.jsxs)("div",{className:"flex items-center justify-center gap-2 font-black uppercase tracking-widest text-xs",children:[e.cta," ",(0,t.jsx)(u.ArrowRight,{size:16})]})})]})]})},r))})})}),(0,t.jsx)("section",{className:"py-10 bg-[var(--c-bg2)] text-[var(--c-fg)] text-center relative overflow-hidden border-t border-[var(--c-border)]",children:(0,t.jsxs)("div",{className:"max-w-4xl mx-auto px-6 relative z-10",children:[(0,t.jsx)("p",{className:"text-xl text-[var(--c-fg2)] font-medium mb-10",children:"Not sure which fits? Start anywhere — every journey links to the others."}),(0,t.jsx)(d.default,{href:"/contact",size:"lg",className:"bg-[var(--c-highlight)] text-black hover:brightness-110 border-none mx-auto",children:(0,t.jsx)("span",{className:"font-black uppercase tracking-widest text-sm",children:"Partner With Us"})})]})})]})}])}]);