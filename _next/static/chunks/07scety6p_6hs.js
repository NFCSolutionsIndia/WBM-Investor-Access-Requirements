...
`;e.s(["default",0,({variant:e="square",pixelSize:c=3,color:d="#B497CF",className:u,style:m,antialias:f=!0,patternScale:p=2,patternDensity:h=1,liquid:x=!1,liquidStrength:g=.1,liquidRadius:b=1,pixelSizeJitter:y=0,enableRipples:w=!0,rippleIntensityScale:C=1,rippleThickness:j=.1,rippleSpeed:k=.3,liquidWobbleSpeed:S=4.5,autoPauseOffscreen:A=!0,speed:E=.5,transparent:N=!0,edgeFade:R=.5,noiseAmount:P=0})=>{let T=(0,r.useRef)(null),M=(0,r.useRef)({visible:!0}),z=(0,r.useRef)(E),I=(0,r.useRef)(null),B=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let e=T.current;if(!e)return;let t=new IntersectionObserver(([e])=>{M.current.visible=e.isIntersecting},{threshold:.01});return t.observe(e),()=>t.disconnect()},[]),(0,r.useEffect)(()=>{let t=T.current;if(!t)return;z.current=E;let r={antialias:f,liquid:x,noiseAmount:P},u=!1;if(I.current){if(B.current){for(let e of["antialias","liquid","noiseAmount"])if(B.current[e]!==r[e]){u=!0;break}}}else u=!0;if(u){let r,u,E;if(I.current){let e=I.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===t&&t.removeChild(e.renderer.domElement),I.current=null}let T=document.createElement("canvas"),B=new s.WebGLRenderer({canvas:T,antialias:f,alpha:!0,powerPreference:"high-performance"});B.domElement.style.width="100%",B.domElement.style.height="100%",B.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.appendChild(B.domElement),N?B.setClearAlpha(0):B.setClearColor(0,1);let F={uResolution:{value:new a.Vector2(0,0)},uTime:{value:0},uColor:{value:new a.Color(d)},uClickPos:{value:Array.from({length:10},()=>new a.Vector2(-1,-1))},uClickTimes:{value:new Float32Array(10)},uShapeType:{value:l[e]??0},uPixelSize:{value:c*B.getPixelRatio()},uScale:{value:p},uDensity:{value:h},uPixelJitter:{value:y},uEnableRipples:{value:+!!w},uRippleSpeed:{value:k},uRippleThickness:{value:j},uRippleIntensity:{value:C},uEdgeFade:{value:R}},L=new a.Scene,D=new a.OrthographicCamera(-1,1,1,-1,0,1),W=new a.ShaderMaterial({vertexShader:n,fragmentShader:o,uniforms:F,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:a.GLSL3}),U=new a.PlaneGeometry(2,2),O=new a.Mesh(U,W);L.add(O);let _=new a.Clock,V=()=>{let e=t.clientWidth||1,i=t.clientHeight||1;B.setSize(e,i,!1),F.uResolution.value.set(B.domElement.width,B.domElement.height),I.current?.composer&&I.current.composer.setSize(B.domElement.width,B.domElement.height),F.uPixelSize.value=c*B.getPixelRatio()};V();let G=new ResizeObserver(V);G.observe(t);let H=1e3*(()=>{if(window.crypto?.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/0xffffffff}return Math.random()})();if(x){var m,q;let e;(u=(()=>{let e=document.createElement("canvas");e.width=64,e.height=64;let t=e.getContext("2d");if(!t)throw Error("2D context not available");t.fillStyle="black",t.fillRect(0,0,e.width,e.height);let i=new a.Texture(e);i.minFilter=a.LinearFilter,i.magFilter=a.LinearFilter,i.generateMipmaps=!1;let r=[],s=null,l=6.4,n=e=>{let i={x:64*e.x,y:(1-e.y)*64},r=1;if(e.age<19.2)r=Math.sin(e.age/19.2*Math.PI/2);else{let t;r=-(t=1-(e.age-19.2)/44.8)*(t-2)||0}r*=e.force;let a=`${(e.vx+1)/2*255}, ${(e.vy+1)/2*255}, ${255*r}`;t.shadowOffsetX=320,t.shadowOffsetY=320,t.shadowBlur=l,t.shadowColor=`rgba(${a},${.22*r})`,t.beginPath(),t.fillStyle=`rgba(${a},${r})`,t.arc(i.x-320,i.y-320,l,0,2*Math.PI),t.fill()};return{canvas:e,texture:i,addTouch:e=>{let t=0,i=0,a=0;if(s){let r=e.x-s.x,l=e.y-s.y;if(0===r&&0===l)return;let n=r*r+l*l,o=Math.sqrt(n);i=r/(o||1),a=l/(o||1),t=Math.min(1e4*n,1)}s={x:e.x,y:e.y},r.push({x:e.x,y:e.y,age:0,force:t,vx:i,vy:a})},update:()=>{t.fillStyle="black",t.fillRect(0,0,e.width,e.height);for(let e=r.length-1;e>=0;e--){let t=r[e],i=.015625*t.force*(1-t.age/64);t.x+=t.vx*i,t.y+=t.vy*i,t.age++,t.age>64&&r.splice(e,1)}for(let e=0;e<r.length;e++)n(r[e]);i.needsUpdate=!0},set radiusScale(v){l=6.4*v},get radiusScale(){return l/6.4},size:64}})()).radiusScale=b,r=new i.EffectComposer(B);let t=new i.RenderPass(L,D);m=u.texture,q={strength:g,freq:S},e=`
