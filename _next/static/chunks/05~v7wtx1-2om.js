(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,48256,e=>{"use strict";let t=(0,e.i(75254).default)("globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);e.s(["Globe",0,t],48256)},70756,e=>{"use strict";let t=(0,e.i(75254).default)("lock",[["rect",{width:"18",height:"11",x:"3",y:"11",rx:"2",ry:"2",key:"1w4ew1"}],["path",{d:"M7 11V7a5 5 0 0 1 10 0v4",key:"fwvmzm"}]]);e.s(["Lock",0,t],70756)},57303,e=>{"use strict";var t=e.i(43476),r=e.i(33623),i=e.i(71645),s=e.i(90072),o=e.i(8560);let a={onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:10,islandWidth:2,lanesPerRoad:4,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:20,lightPairsPerRoadWay:40,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[12,80],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.8,.8],carFloorSeparation:[0,5],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:0xffffff,brokenLines:0xffffff,leftCars:[0xd856bf,6770850,0xc247ac],rightCars:[242627,941733,3294549],sticks:242627}};e.s(["default",0,({effectOptions:e,speed:n,color:l})=>{let c=(0,i.useRef)(null),d=(0,i.useRef)(null);return(0,i.useEffect)(()=>{if(d.current){d.current.dispose(),d.current=null;let e=c.current;if(e)for(;e.firstChild;)e.removeChild(e.firstChild)}let t={uFreq:{value:new s.Vector3(3,6,10)},uAmp:{value:new s.Vector3(30,30,20)}},i={uFreq:{value:new s.Vector2(5,2)},uAmp:{value:new s.Vector2(25,15)}},u={uFreq:{value:new s.Vector2(2,3)},uAmp:{value:new s.Vector2(35,10)}},h={uFreq:{value:new s.Vector4(4,8,8,1)},uAmp:{value:new s.Vector4(25,5,10,10)}},m={uFreq:{value:new s.Vector2(4,8)},uAmp:{value:new s.Vector2(10,20)},uPowY:{value:new s.Vector2(20,2)}},p=e=>.5*Math.sin(e)+.5,f={mountainDistortion:{uniforms:t,getDistortion:`
          uniform vec3 uAmp;
          uniform vec3 uFreq;
        ...
        `,getJS:(e,t)=>{let r=u.uFreq.value,i=u.uAmp.value,o=new s.Vector3(Math.sin(e*Math.PI*r.x+t)*i.x-Math.sin(.0125*Math.PI*r.x+t)*i.x,Math.sin(e*Math.PI*r.y+t)*i.y-Math.sin(.0125*Math.PI*r.y+t)*i.y,0),a=new s.Vector3(1,1,0),n=new s.Vector3(0,0,-5);return o.multiply(a).add(n)}},turbulentDistortion:{uniforms:h,getDistortion:`
          uniform vec4 uFreq;
          uniform vec4 uAmp;
          float nsin(float val){
            return sin(val) * 0.5 + 0.5;
        ...
        `,getJS:(e,t)=>{let r=m.uFreq.value,i=m.uAmp.value,o=m.uPowY.value,a=e=>Math.sin(e*Math.PI*r.x+t)*i.x,n=e=>Math.pow(e*o.x,o.y)+Math.sin(e*Math.PI*r.y+t)*i.y,l=new s.Vector3(a(e)-a(e+.01),n(e)-n(e+.01),0),c=new s.Vector3(-2,-4,0),d=new s.Vector3(0,0,-10);return l.multiply(c).add(d)}}},g={uDistortionX:{value:new s.Vector2(80,3)},uDistortionY:{value:new s.Vector2(-40,2.5)}},v=`
      #define PI 3.14159265358979
    ...
    `;class j{webgl;options;mesh=null;constructor(e,t){this.webgl=e,this.options=t}init(){let e=this.options,t=new s.PlaneGeometry(1,1),r=new s.InstancedBufferGeometry().copy(t),i=e.totalSideLightSticks;r.instanceCount=i;let o=e.length/(i-1),a=[],n=[],l=[],c=e.colors.sticks;c=Array.isArray(c)?c.map(e=>new s.Color(e)):new s.Color(c);for(let t=0;t<i;t++){let r=x(e.lightStickWidth),i=x(e.lightStickHeight);a.push((t-1)*o*2+o*Math.random());let s=w(c);n.push(s.r),n.push(s.g),n.push(s.b),l.push(r),l.push(i)}r.setAttribute("aOffset",new s.InstancedBufferAttribute(new Float32Array(a),1,!1)),r.setAttribute("aColor",new s.InstancedBufferAttribute(new Float32Array(n),3,!1)),r.setAttribute("aMetrics",new s.InstancedBufferAttribute(new Float32Array(l),2,!1));let d=new s.ShaderMaterial({fragmentShader:S,vertexShader:M,side:s.DoubleSide,uniforms:Object.assign({uTravelLength:{value:e.length},uTime:{value:0}},this.webgl.fogUniforms,e.distortion.uniforms)});d.onBeforeCompile=t=>{t.vertexShader=t.vertexShader.replace("#include <getDistortion_vertex>",e.distortion.getDistortion)};let u=new s.Mesh(r,d);u.frustumCulled=!1,this.webgl.scene.add(u),this.mesh=u}update(e){this.mesh&&(this.mesh.material.uniforms.uTime.value=e)}}let M=`
      #define USE_FOG;
      ${o.ShaderChunk.fog_pars_vertex}
    ...
    `,C=A.replace("#include <roadMarkings_fragment>","").replace("#include <roadMarkings_vars>",""),N=`
    ...
    `,T=A.replace("#include <roadMarkings_fragment>",F).replace("#include <roadMarkings_vars>",N),D=`
      #define USE_FOG;
      uniform float uTime;
      ${o.ShaderChunk.fog_pars_vertex}
      uniform float uTravelLength;
